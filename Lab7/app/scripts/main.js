...
let data2 = [{ k: 'catA', v: 23 }, { k: 'catB', v: 54 }, { k: 'catC', v: 98 }, { k: 'catD', v: 37 }];

// let barchart1 = new BarChart('div#bar1', 800, 500, [30, 30, 30, 30]);
// let barchart2 = new BarChart('div#bar2', 600, 400);
let bubblechart = new BubbleChart('div#bubble1', 800, 400, [30, 30, 30, 30]);
